...
Guidance extracted from the project abstract assignment. Update when later milestones (final report, presentation, etc.) are posted.
...
Final code, report, and/or presentation requirements are **not yet recorded** here. Add them when the syllabus posts them.
